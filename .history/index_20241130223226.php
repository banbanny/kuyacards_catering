        ...
        if (empty($email) || empty($password)) {
            ...
            try {
                ...
                if ($user && $password === $user['password']) {  // Plain-text password comparison
                    ...
                    // Debugging: Log user info to console using JavaScript
                    echo "<script>console.log('User Info: ', " . json_encode($user) . ");</script>";
        ...
        if (empty($email) || empty($password)) {
            ...
            try {
                ...
                if ($stmt->fetchColumn() > 0) {
                    ...
                    // Insert new user with plain text password (hashing should be implemented)
