...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['login'])) {
        // Login Process
        $email = trim(htmlspecialchars(strip_tags($_POST['login_email'])));
        ...
        if ($user) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                $_SESSION['user_id'] = $user['id'];  // Store user_id to identify logged-in user
    ...
    if (isset($_POST['signup'])) {
        ...
        if (!empty($_POST['signup_email']) && !empty($_POST['signup_password'])) {
            $email = trim(htmlspecialchars(strip_tags($_POST['signup_email'])));
            $password = trim(htmlspecialchars(strip_tags($_POST['signup_password'])));
