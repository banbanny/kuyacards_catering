...
if (isset($_POST["next"])) {
    ...
    if ($numRows > 0) {
        ...
        $sqlInsertBooking = "INSERT INTO bookingdates (date, time, refNo) 
                             VALUES (?, ?, ?)";
...
function generatePdf($conn, $bookingID)
{
    ...
    $sql = "SELECT b.bookingID, b.date, b.time, b.hours
            FROM bookingdates b
  ...
  <form method="post">
    <div class="container text-center">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control w-50 mx-auto" name="refNo">
      </div>
    ...
    <footer id="footer">
      <section class="footer-top">
        <div class="container">
          <h5>Stay updated with our services</h5>
