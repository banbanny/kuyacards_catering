...
if (isset($_POST['login'])) {
    ...
    // Query to fetch userID and password (adjust column name if needed)
    $query = "SELECT userID, password FROM users WHERE username = ?";  // Assuming column name is userID
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($pass, $row['password'])) {
            ...
            header("Location: staff_index.php");   // Redirect to the staff index page
