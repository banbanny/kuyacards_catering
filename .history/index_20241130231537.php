...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            try {
                ...
                if ($user) {
                    ...
                    if ($password === $user['password']) {
                        ...
                        $_SESSION['user_id'] = $user['id'];   // Ensure you're using the correct field name for user ID
                        $_SESSION['email'] = $user['email'];  // Store email as session value
                        
                        // Ensure that the session is being set properly by checking it in the following request
    ...
    if (isset($_POST['signup'])) {
        ...
        if (!empty($_POST['email']) && !empty($_POST['password'])) {
            try {
                // Sanitize email and plain text password
