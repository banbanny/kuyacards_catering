...
<div id="customers" class="content-page">
  ...
  <table class="table table-bordered table-striped">
            ...
            <?php 
          // Iterate through the customer results and display in table rows
          foreach ($orders_manage as $order) {
            echo '<tr>
                    ...
                    <td>' .$order['role'] . '</td>
                    <td>
                    <a href="customers.php?delete_id='.$order['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this customer?\')">Delete</a>
                  </td>
                  </tr>';
          }
        ?>
