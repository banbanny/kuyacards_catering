                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="package_description" name="package_description" value="<?php echo $datas['description']?>"" rows="3" required></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="package_items" class="form-label">Items</label>
                            <textarea class="form-control" id="package_items" name="package_items" rows="3" value="<?php echo $datas['items']?>"" required></textarea>
                        </div>

                        <!-- Package Price -->
                        <div class="mb-3">
                            <label for="package_price" class="form-label">Package Price</label>
                            <input type="number" class="form-control" id="package_price" name="package_price" value="<?php echo $datas['package_name']?>"" required>
                        </div>
                        <?php } ?>
