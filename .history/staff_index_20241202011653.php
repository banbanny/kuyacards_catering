...
// Include logic for checking user role, and possibly logging out
?>
        ...
        <div id="customers" class="content-page">
            <div class="container mt-3">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <!-- Populate with customer data similar to the Staff page -->
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div id="orders" class="content-page">
            ...
            <div class="container mt-3">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <!-- Populate orders from the database -->
                    </tbody>
                </table>
            </div>
        </div>
    ...
    <script>
        ...
        editBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                // For example:
                console.log(`Editing package ID: ${btn.dataset.id}`);
            });
        });
        ...
        deleteBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                confirmBtn.addEventListener('click', () => {
                    console.log(`Deleting package ID: ${btn.dataset.id}`);
                    modal.hide();
                });
            });
        });
