...
if ($orders) {
  foreach ($orders as $order) {
      ...
      echo "<strong>date:</strong> " . htmlspecialchars($order['quantity']) . "<br>";
      echo "<strong>time:</strong> $" . htmlspecialchars($order['price']) . "<br>";
      echo "<strong>method:</strong> $" . htmlspecialchars($order['total']) . "<br>";
