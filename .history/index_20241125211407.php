...
// Check if a success login flag is set in the session
if (isset($_SESSION['login_success']) && $_SESSION['login_success'] === true) {
  $loginMessage = "You are successfully logged in!";
  unset($_SESSION['login_success']); // Remove the flag after showing the message
}
...
<html lang="en">
  <head>
    ...
    <script>
        // Show the login success message if it exists
