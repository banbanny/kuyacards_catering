...
<body>
    ...
    <main class="container">
        <section class="hero container">
            ...
            <button onclick="window.location.href='index.php';">Order Now</button>
        </section>
    </main>
        ...
        <div class="flex-container">
            ...
            <div class="flex-item">
                <ul class="package">
                    ...
                    <li>Chopsuey</li>
                    <li>Salted Shrimp</li>
                    <li><button onclick="addToCart('PACKAGE B', 6400)">Add to Cart</button></li>
                </ul>
            </div>
            <!-- Package C -->
            <div class="flex-item">
                <ul class="package">
                    ...
                    <li><button onclick="addToCart('PACKAGE C', 8050)">Add to Cart</button></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <footer id="footer">
        <p>&copy; 2023 Kuya Card's Catering. All Rights Reserved.</p>
    </footer>

    <script>
        function addToCart(packageName, price) {
            alert(`${packageName} added to cart for PHP ${price}`);
            const cartCountElement = document.getElementById('cart-count');
            let count = parseInt(cartCountElement.innerText) || 0;
