...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->execute()) {
        // Redirect back to the customers page after deletion
        ...
        <?php 
          ...
          foreach ($customer_results as $customer) {
            echo '<tr>
                    ...
                    <td>' .$customer['role'] . '</td>
                    <td>
                    <a href="customers.php?delete_id='.$customer['id'].'" 
                    class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this customer?\')">Delete</a>
                  </td>
                  </tr>';
          }
        ?>
