...
<div class="receipt-container">
    <div class="receipt-header">
        ...
        <p>Order Number: <strong>#<?php $order['pending_order_id'] ?></strong></p>
        <p>Date of Order: <strong><?php $order['pending_order_id'] ?></strong></p>
        <p>Time of Order: <strong><?php $order['pending_order_id'] ?>HH:MM AM/PM</strong></p>
        <?php } ?>
    </div>
