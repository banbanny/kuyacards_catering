        ...
        <div class="container">
          ...
          foreach ($packages_results as $package) {
            echo '<tr>
                    ...
                    <td>' .$package['items']. '</td>
                    <td>
                    <a href="delete_customer.php?delete_id='.$package['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to update this customer?\')">Update</a>
