...
<div class="receipt-container">
    <div class="receipt-header">
        ...
        <?php foreach($orders as $order) { 
         echo <p>Order Number: <strong>#<?php $order['pending_order_id'] ?></strong></p>
         echo <p>Date of Order: <strong><?php $order['date_of_delivery'] ?></strong></p>
         echo <p>Time of Order: <strong><?php $order['time_of_delivery'] ?></strong></p>
       } ?>
    </div>
