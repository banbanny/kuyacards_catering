        ...
        <div class="flex-container">
            ...
            <div class="flex-item">
                <ul class="package">
                    ...
                    <li class="gray">&#8369;7,300<br><span class="month">Good For 20 Persons</span></li>
                    <li>Pancit Malabon</li>
                    <li>Grilled Liempo</li>
                    <li>Beef Steak</li>
                    <li>Butter Garlic Shrimp</li>
                    <li>Chopsuey</li>
                    <form method="POST">
            ...
            <div class="flex-item">
                <ul class="package">
                    <li class="header">PACKAGE D</li>
                    <li class="gray">&#8369;6,900<br><span class="month">Good For 15 Persons</span></li>
                    <li>Bihon Guisado</li>
                    <li>Buttered Chicken</li>
                    <li>Chicken Cordon Bleu</li>
                    <li>Chopsuey</li>
