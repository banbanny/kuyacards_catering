    ...
    if (isset($_POST['signup'])) {
        ...
        if (!empty($_POST['email']) && !empty($_POST['password'])) {
            ...
            try {
                ...
                if ($result) {
                    header("Location: index.php?signup=success"); // Redirect to login form
                    exit();
                } else {
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Login Form -->
                    <form id="loginForm" class="form-container active" action="index.php" method="POST">
                        <h4>Login</h4>
                        <div class="mb-3">
                    ...
                    <!-- Sign Up Form -->
                    <form id="signupForm" class="form-container" action="indx.php" method="POST">
                        <h4>Sign Up</h4>
                        <div class="mb-3">
