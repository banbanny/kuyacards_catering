...
$stmt = $db->prepare("SELECT * FROM customer_detail cd INNER JOIN pending_orders po ON po.id = cd.pending_order_id INNER JOIN users u ON u. cd.user_id WHERE cd.id = :id ");
