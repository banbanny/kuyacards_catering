...
<html lang="en">
  ...
  <form method="post">
    ...
    <input type="text" class="form-control" name="payment_method" placeholder="e.g., Online Payment, Cash" required>
    <br>
    
    <!-- Reference Number -->
    <label>Reference Number</label>
    <input type="text" class="form-control" name="ref_no" placeholder="Enter payment reference number" required>
    <br>
    ...
    <div class="text-center">
      <img src="pics/GcashPayment.jpg" alt="Gcash Payment" style="width: 25%;">
    </div>
    <br>
