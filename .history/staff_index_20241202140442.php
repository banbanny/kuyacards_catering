...
<?php
    ...
    $stmt = $db->prepare("SELECT * id, email, password, full_name, address, contact_number, role FROM users");
    $stmt->execute();
        ...
        <div class="container">
          ...
          foreach ($package_results as $package) {
            echo '<tr>
                    ...
                    <a href="add_package.php?add_id='.$package['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to add a package?\')">Add</a>
