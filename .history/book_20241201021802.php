...
if (isset($_POST["next"])) {
    ...
    if ($numRows > 0) {
        ...
        // Insert booking information into customer_detail
        ...
        $stmt1->bind_param("ssss", $dateFormat, $time, $paymentMethod, $refNo);
...
function generatePdf($conn, $bookingID)
{
    ...
    $sql = "SELECT b.bookingID, b.date_of_delivery, b.time_of_delivery
            FROM customer_detail b
            WHERE b.id = ?";
