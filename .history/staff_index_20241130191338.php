  ...
  <body>
    <div class="sidebar">
      ...
      <nav class="nav flex-column sidebar-nav mt-3">
        <a href="#lechon" class="nav-link active" data-page="lechon">Lechon Products</a>
        <a href="#viand" class="nav-link" data-page="viand">Viand Products</a>
    ...
    <div class="main-content">
      ...
      <div id="viand" class="content-page">
        <h1>Viand Products</h1>
        <p>Content for Viand Products will be displayed here.</p>
      </div>
