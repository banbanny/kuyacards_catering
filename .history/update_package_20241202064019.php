                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="package_description" name="package_description" rows="3" required>
                                <?php echo htmlspecialchars($datas['description']); ?>
                            </textarea>
                        </div>

                        <div class="mb-3">
                            <label for="package_items" class="form-label">Items</label>
                            <textarea class="form-control" id="package_items" name="package_items" rows="3" required>
                            <?php echo htmlspecialchars($datas['items']); ?>
                            </textarea>
                        </div>
