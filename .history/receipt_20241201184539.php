...
if ($orders) {
  foreach ($orders as $order) {
      echo "<p><strong>Item:</strong> " . htmlspecialchars($order['item_name']) . "<br>";
      echo "<strong>Quantity:</strong> " . htmlspecialchars($order['quantity']) . "<br>";
      echo "<strong>Price:</strong> $" . htmlspecialchars($order['price']) . "<br>";
      echo "<strong>Total:</strong> $" . htmlspecialchars($order['total']) . "<br>";
      echo "<strong>Status:</strong> " . htmlspecialchars($order['status']) . "</p>";
  }
} else {
