...
<div class="receipt-container">
    ...
    <table class="info-table">
        <?php foreach ($orders as $order): ?>
            <tr>
                <td><strong>Name:</strong> <?= htmlspecialchars($order['full_name']) ?></td>
                <td><strong>Email:</strong> <?= htmlspecialchars($order['email']) ?></td>
            </tr>
            <tr>
                <td><strong>Address:</strong> <?= htmlspecialchars($order['address']) ?></td>
                <td><strong>Phone:</strong> <?= htmlspecialchars($order['contact_number']) ?></td>
            </tr>
        <?php endforeach; ?>
    </table>
</div>
...
<div class="delivery-info">
    ...
    <table class="info-table">
        <?php foreach ($orders as $order): ?>
            <tr>
                <td><strong>Delivery Address:</strong> <?= htmlspecialchars($order['address']) ?></td>
            </tr>
        <?php endforeach; ?>
    </table>
</div>
