...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['login'])) {
        ...
        if ($user) {
            // You can log user data to check if the query is successful (avoid printing sensitive data in production)
            // var_dump($user); // Uncomment this for debugging purposes
        } else {
            echo "No user found with that email.<br>";
        }

        // Verify if the user is found and the password matches
