...
<html lang="en">
  ...
  <form method="post">
    ...
    <div id="gcashQR" style="display: none; text-align: center;">
      <label>Scan the Gcash QR Code to Pay</label>
...
<script>
  // JavaScript to toggle Gcash QR Code
  document.getElementById('paymentMethod').addEventListener('change', function () {
    const gcashQR = document.getElementById('gcashQR');
    if (this.value === 'Gcash') {
      gcashQR.style.display = 'block'; // Show QR code
    } else {
      gcashQR.style.display = 'none'; // Hide QR code
    }
  });
</script>
